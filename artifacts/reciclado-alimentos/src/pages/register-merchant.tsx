...
async function geocodeAddress(address: string) {
  const url = `https://nominatim.openstreetmap.org/search?format=json&countrycodes=ar&q=${encodeURIComponent(
    address,
  )}&limit=1`;
...
export default function RegisterMerchantPage() {
  ...
  const [merchantLocation, setMerchantLocation] = useState<MapLocation>({
    lat: -24.7821,
    lng: -65.4232,
  });
      ...
      },
      {
        onSuccess: (res: AuthResponse) => {
          ...
          toast({
            ...
            description: "Bienvenido a Rescaté",
          });
      ...
      <div className="max-w-2xl mx-auto px-4">
        ...
        <div className="bg-card border border-card-border rounded-2xl p-8 shadow-sm">
          ...
          <p className="text-muted-foreground mb-6 text-sm">
            Completá los datos para empezar a publicar productos
          </p>
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <Input
                  ...
                  placeholder="Ej: Panadería La Buena"
              ...
              <div>
                ...
                <select
                  ...
                  className="mt-1.5 w-full border border-input rounded-lg px-3 py-2 text-sm bg-background"
                >
            ...
            <Button
              ...
              variant="outline"
              onClick={async () => {
                const fullAddress = `${addressLine}, ${city}, ${province}, Argentina`;
                ...
                if (!coords) {
                  alert(
                    "No se encontró la dirección. Probá escribirla más completa o mover el pin manualmente.",
                  );
                  return;
                }

                setMerchantLocation(coords);
              }}
            >
              Ubicar en el mapa
            </Button>
            ...
            <div>
              ...
              <Textarea
                ...
                placeholder="Contale a tus clientes sobre tu comercio..."
            ...
            <div>
              ...
              <Input
                {...form.register("pickupHours")}
                placeholder="Ej: Lunes a Viernes 9:00 - 18:00"
                data-testid="input-pickupHours"
                className="mt-1.5"
              />
            </div>
